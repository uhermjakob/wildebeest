...
This file contains functions that build UnicodeData-based data tables or Python code lines for wildebeest_normalize.py
"""
...
def norm_string_by_mapping_dict(s: str, m_dict: dict, wb: wb_norm.Wildebeest,
